...
$finder = PhpCsFixer\Finder::create()
    ->in('.')
    ->exclude([
        '.bin', '.cache', '.config', '.git', '.githooks', '.install', '.output', '.tools',
        'bootstrap', 'config', 'node_modules', 'storage', 'tests', 'vendor'
    ]);

// Use an external file so that file so we can push a generic .php-cs-fixer.php file
// for all our BOSA projects and don't touch to the licenseHeader.txt file of the project itself
...
return $config->setRules(
    [
        ...
        // https://mlocati.github.io/php-cs-fixer-configurator/#version:2.16|fixer:no_unused_imports
