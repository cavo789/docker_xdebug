...
return [
    ...
    // Set this to false to emit `PhanUndeclaredFunction` issues for
    // internal functions that Phan has signatures for,
    ...
    // or to indicate a preference for non-nullable types over nullable types)
    //
    // This setting affects the analysis of return statements in the body of
    // the method and the return types passed in by callers.
    ...
    // (E.g. `@return the|null` will still look for a class with the name `the`, but `@return the`
    // will be ignored with the below setting)
    //
    // (These are not aliases, this setting is ignored outside of doc comments).
    // (Phan does not check if classes with these names exist)
    //
    // Example setting: `['unknown' => '', 'number' => 'int|float', 'char' => 'string',
    //      'long' => 'int', 'the' => '']`
    'phpdoc_type_mapping' => [],
    ...
    //
    // ```
    // test.php:3 PhanTypeMismatchReturn Returning type string but test() is
    ...
    // Override to hardcode existence and types of (non-builtin) globals in the
    // global scope.
    ...
    // A file list that defines files that will be included in static analysis, to the
    // exclusion of others.
    ...
    // The `tools/make_stubs` script can be used to generate your own stubs (compatible
    // with php 7.0+ right now)
    //
    ...
    // [here](https://github.com/phan/phan/tree/master/.phan/plugins).
    //
    // Alternately, you can pass in the full path to a PHP file with the plugin's
    // implementation (e.g. `'vendor/phan/phan/.phan/plugins/AlwaysReturnPlugin.php'`)
    'plugins' => [
        //'AlwaysReturnPlugin',
        //'DollarDollarPlugin',
    ...
    'directory_list' => [
        ...
        'database/seeds',
        'routes/Dispatchers',
        'vendor/bensampo/laravel-enum/src',
        'vendor/bosa/bosa/app',
