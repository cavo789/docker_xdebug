...
/*
 * This file is part of the Federal Data Manager application; part of
 * the Crescendo 2 applications suite
 * (c) SPF BOSA IOD AS - PHP Dev Team
 * 2018 - 2020
 */
 ...
 *   (E.g. this only includes direct composer dependencies - You may have to manually
 *   add indirect composer dependencies to 'directory_list')
 * - Look at 'plugins' and add or remove plugins if appropriate
 *   (see https://github.com/phan/phan/tree/master/.phan/plugins#plugins)
